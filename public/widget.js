(function() {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '#ff-widget-overlay{position:fixed;inset:0;z-index:99999;background:rgba(15,16,35,0.7);backdrop-filter:blur(4px);display:flex;align-items:flex-end;justify-content:center;padding:0;opacity:0;transition:opacity 0.3s ease;}',
      '#ff-widget-overlay.ff-open{opacity:1;}',
