...
const STATUS_COLORS: Record<string, { bg: string; text: string; label: string }> = {
  ...
  completed:         { bg: "rgba(39,41,92,0.1)",  text: "#000000", label: "Completada" },
    ...
    <>
      <div className="rounded-2xl border transition-all duration-200 hover:shadow-md overflow-hidden"
        ...
        {appt.status === "pending_assignment" && (
          <div className="h-1" style={{ background: "#0183FF" }} />
        )}
        ...
        <div className="p-5">
          ...
          <div className="flex items-start justify-between gap-3 mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-semibold text-sm" style={{ color: "#000000" }}>{appt.clientName}</p>
          ...
          <div className="grid grid-cols-2 gap-2 mb-4">
            <div className="flex items-center gap-2 text-xs" style={{ color: "#6B7280" }}>
              ...
              <span className={isToday ? "font-semibold" : ""} style={{ color: isToday ? "#0183FF" : undefined }}>
                {isToday ? "HOY" : dateStr}
              </span>
            </div>
            <div className="flex items-center gap-2 text-xs" style={{ color: "#6B7280" }}>
          ...
          {appt.repName && (
            <div className="flex items-center gap-2 mb-4 px-3 py-2 rounded-lg"
              ...
              <span className="text-xs" style={{ color: "#000000" }}>{appt.repName}</span>
            </div>
          )}
          ...
          <button onClick={() => setShowNotes(!showNotes)}
            ...
            style={{
              borderColor: showNotes ? "#000000" : "#E5E7EB",
              background: showNotes ? "rgba(39,41,92,0.04)" : "transparent",
              color: showNotes ? "#000000" : "#9CA3AF",
            }}>
            📝 Notas internas
            {showNotes ? " ▲" : " ▼"}
          </button>
