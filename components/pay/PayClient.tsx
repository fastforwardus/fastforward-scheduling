...
const T: Record<Lang, Record<string, string>> = {
  es: {
    ...
    payNote: "Se abrirá una ventana segura. Haga clic en \"Pay Now\" para completar el pago.",
    bankTitle: "Transferencia bancaria",
    bankBody: "Escríbanos a info@fastfwdus.com para recibir los datos bancarios.",
