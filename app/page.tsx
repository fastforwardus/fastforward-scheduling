...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0F1023] text-gray-900 dark:text-white transition-colors duration-300">
      ...
      <header className="fixed inset-x-0 top-0 z-50 h-16 bg-white/95 dark:bg-[#0F1023]/95 border-b border-gray-100 dark:border-white/5 backdrop-blur-md transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="block dark:hidden">
            <Image src="https://fastfwdus.com/wp-content/uploads/2025/05/logoR.png" alt="FastForward ® | FDA Experts" width={155} height={34} className="object-contain" priority />
          </div>
          <div className="hidden dark:block">
            <Image src="https://fastfwdus.com/wp-content/uploads/2025/04/logorwhitehorizontal.png" alt="FastForward ® | FDA Experts" width={155} height={34} className="object-contain" priority />
          </div>
          <div className="flex items-center gap-2">
            ...
            <ThemeToggle />
            <a href="/book" className="hidden sm:flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 bg-[#27295C] hover:bg-[#1A1C3E] text-white dark:bg-[#C9A84C] dark:hover:bg-[#E5BA52]">
      ...
      <section className="pt-16 min-h-screen flex flex-col justify-center bg-white dark:bg-[#1A1C3E] transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6 py-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full mb-10 border border-gray-200 dark:border-[#C9A84C]/20 bg-gray-50 dark:bg-[#C9A84C]/8 text-gray-500 dark:text-[#C9A84C] text-xs font-medium tracking-widest uppercase">
              {t.pill}
            </div>
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight mb-8 text-[#27295C] dark:text-white" style={{ letterSpacing: "-0.03em" }}>
              {t.h1a}<br />
              <span className="text-[#C9A84C]">{t.h1b}</span>
            </h1>
            <p className="text-lg text-gray-500 dark:text-white/50 mb-12 max-w-2xl leading-relaxed">{t.sub}</p>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <a href="/book" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-base transition-all duration-200 hover:-translate-y-0.5 bg-[#27295C] hover:bg-[#1A1C3E] text-white hover:shadow-xl hover:shadow-[#27295C]/20 dark:bg-[#C9A84C] dark:hover:bg-[#E5BA52] dark:hover:shadow-[#C9A84C]/30">
                {t.cta} <ArrowRight className="w-4 h-4" />
              </a>
              <span className="text-sm text-gray-400 dark:text-white/30">{t.ctaSub}</span>
            </div>
          </div>
          <div className="flex flex-wrap gap-x-12 gap-y-6 mt-20 pt-12 border-t border-gray-100 dark:border-white/8">
            {t.stats.map((s) => (
              <div key={s.n}>
                <div className="text-3xl font-bold text-[#27295C] dark:text-[#C9A84C]" style={{ letterSpacing: "-0.02em" }}>{s.n}</div>
                <div className="text-sm text-gray-400 dark:text-white/40 mt-0.5">{s.l}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50 dark:bg-[#0F1023] transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl font-bold mb-12 text-[#27295C] dark:text-white">{t.servicesTitle}</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {t.services.map((s) => (
              <div key={s.cat} className="p-6 rounded-2xl bg-white dark:bg-[#1A1C3E] border border-gray-100 dark:border-white/5 hover:border-[#C9A84C]/40 dark:hover:border-[#C9A84C]/30 transition-all duration-200">
      ...
      <section className="py-24 bg-white dark:bg-[#1A1C3E] transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl font-bold mb-12 text-[#27295C] dark:text-white">{t.testimonialsTitle}</h2>
          <div className="grid sm:grid-cols-3 gap-6">
            {t.testimonials.map((testimonial) => (
              <div key={testimonial.author} className="p-6 rounded-2xl border border-gray-100 dark:border-white/5 bg-gray-50 dark:bg-[#0F1023]">
                <p className="text-gray-600 dark:text-white/60 text-sm leading-relaxed mb-6">&ldquo;{testimonial.text}&rdquo;</p>
      ...
      <section className="py-20 bg-[#27295C]">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-8">
          <div>
            <p className="text-white/40 text-xs mb-1 uppercase tracking-widest">FastForward ® | FDA Experts</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-white" style={{ letterSpacing: "-0.02em" }}>{t.ctaBanner}</h2>
          </div>
          <a href="/book" className="flex-shrink-0 inline-flex items-center gap-2 px-7 py-3.5 rounded-xl font-semibold text-[#27295C] bg-[#C9A84C] hover:bg-[#E5BA52] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#C9A84C]/30 whitespace-nowrap">
            {t.cta} <ArrowRight className="w-4 h-4" />
          </a>
        </div>
      </section>

      <footer className="py-10 bg-white dark:bg-[#0F1023] border-t border-gray-100 dark:border-white/5 transition-colors duration-300">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="block dark:hidden">
            <Image src="https://fastfwdus.com/wp-content/uploads/2025/05/logoR.png" alt="FastForward ® | FDA Experts" width={130} height={30} className="object-contain" />
          </div>
          <div className="hidden dark:block">
            <Image src="https://fastfwdus.com/wp-content/uploads/2025/04/logorwhitehorizontal.png" alt="FastForward ® | FDA Experts" width={130} height={30} className="object-contain" />
          </div>
          <p className="text-gray-400 dark:text-white/20 text-xs text-center sm:text-right">
