...
<div style="font-family:system-ui,sans-serif;max-width:520px;margin:0 auto;padding:24px;">
  ...
  <div style="background:white;border-radius:0 0 16px 16px;padding:32px;border:1px solid #E5E7EB;border-top:none;">
    <p style="font-size:20px;font-weight:700;color:#000000;margin:0 0 8px;">Hola, ${firstName} 👋</p>
    <p style="color:#6B7280;font-size:14px;margin:0 0 20px;">
      Vimos que empezaste a agendar una consulta sobre <strong style="color:#000000;">${serviceLabel}</strong> pero no la completaste.
    </p>
    <p style="color:#6B7280;font-size:14px;margin:0 0 24px;">
      La consulta es <strong style="color:#000000;">gratuita y sin compromiso</strong>. Solo toma 30 minutos y podes hacerla por Google Meet, Zoom o WhatsApp.
    </p>
    ...
    <a href="${bookUrl}"
       style="display:block;text-align:center;background:#0183FF;color:#000000;padding:16px;border-radius:12px;font-weight:700;text-decoration:none;font-size:15px;margin-bottom:16px;">
    ...
    <div style="border-top:1px solid #F0F0F0;padding-top:20px;margin-top:24px;text-align:center;">
      ...
      <p style="font-size:12px;color:#9CA3AF;margin:0;">
        <a href="https://fastfwdus.com" style="color:#0183FF;">fastfwdus.com</a> · Miami, FL
      </p>
    </div>
  </div>
</div>`,
