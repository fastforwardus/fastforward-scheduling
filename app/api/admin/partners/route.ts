...
<div style="font-family:system-ui,sans-serif;max-width:560px;margin:0 auto;padding:24px;">
  <div style="background:#000000;border-radius:16px 16px 0 0;padding:32px;text-align:center;">
  ...
  <div style="background:white;border-radius:0 0 16px 16px;padding:32px;border:1px solid #E5E7EB;border-top:none;">
    <p style="font-size:22px;font-weight:700;color:#000000;margin:0 0 8px;">Hola, ${name}! 👋</p>
    <p style="color:#6B7280;font-size:14px;margin:0 0 24px;">
      Nos alegra darte la bienvenida al <strong style="color:#000000;">Programa de Partners de FastForward FDA Experts</strong>.
    ...
    <div style="background:#F8F9FB;border-radius:12px;padding:20px;margin-bottom:24px;border:1px solid #E5E7EB;">
      <p style="font-size:13px;font-weight:700;color:#000000;margin:0 0 12px;text-transform:uppercase;letter-spacing:0.05em;">Tus datos de acceso</p>
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr><td style="padding:6px 0;border-bottom:1px solid #F0F0F0;">
          ...
          <a href="${appUrl}/partner/${slug}" style="font-size:14px;font-weight:600;color:#0183FF;">${appUrl}/partner/${slug}</a>
        </td></tr>
        <tr><td style="padding:6px 0;border-bottom:1px solid #F0F0F0;">
          <span style="font-size:11px;color:#9CA3AF;text-transform:uppercase;">Tu link exclusivo de referidos</span><br>
          <a href="${appUrl}/book/partner/${slug}" style="font-size:14px;font-weight:600;color:#0183FF;">${appUrl}/book/partner/${slug}</a>
        </td></tr>
        <tr><td style="padding:6px 0;">
          <span style="font-size:11px;color:#9CA3AF;text-transform:uppercase;">Contrasena</span><br>
          <span style="font-size:14px;font-weight:600;color:#000000;">${password}</span>
        </td></tr>
      </table>
    </div>

    <div style="background:#EEF2FF;border-radius:12px;padding:16px;margin-bottom:24px;border-left:4px solid #6366F1;">
      <p style="font-size:13px;font-weight:700;color:#000000;margin:0 0 8px;">Proximos pasos</p>
    ...
    <div style="border-top:1px solid #F0F0F0;padding-top:20px;margin-top:8px;text-align:center;">
      ...
      <p style="font-size:12px;color:#9CA3AF;margin:0;">
        Consultas: <a href="mailto:info@fastfwdus.com" style="color:#0183FF;">info@fastfwdus.com</a> |
