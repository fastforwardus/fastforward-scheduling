...
const TEMPLATES: Record<string, Record<Lang, Tpl>> = {
  propuesta_recordatorio_1: {
    es: { body: "Hola {{1}}, soy Adriana de FastForward. Te enviamos la propuesta {{2}} y queria saber si pudiste revisarla. Si tienes alguna duda responde por aqui.", btn: "Ver propuesta" },
  ...
  propuesta_recordatorio_2: {
    es: { body: "Hola {{1}}, te escribo de nuevo por la propuesta {{2}}. Sigue disponible y el plazo se acerca. Si quieres avanzar o resolver alguna duda, responde por aqui.", btn: "Ver propuesta" },
  ...
  propuestas_pendientes_resumen: {
    es: { body: "Hola {{1}}, tienes {{2}} propuestas pendientes de confirmacion con FastForward, por un total de USD {{3}}. Si quieres revisarlas o tienes alguna duda, responde por aqui y te ayudo.", btn: "" },
  ...
  contacto_web_seguimiento: {
    es: { body: "Hola {{1}}, soy Adriana de FastForward. Recibimos tu consulta desde nuestra web sobre {{2}}. Si lo deseas, responde por aqui y coordinamos una llamada sin costo con uno de nuestros consultores para ver tu caso.", btn: "" },
  ...
  reactivacion_consulta_b: {
    es: { body: "Hola {{1}}, soy Adriana de FastForward, consultora de Miami especializada en entrada al mercado de Estados Unidos. Hace un tiempo nos consultaste por {{2}}. Una pregunta corta: ¿sigues con ese proyecto? Si me respondes SI, te paso horarios para una llamada sin costo con un consultor esta misma semana.", btn: "" },
