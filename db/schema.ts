...
export const proposals = pgTable("proposals", {
  ...
  whatsappLastSentAt: timestamp("whatsapp_last_sent_at", { withTimezone: true }),
...
export const adrianaConversations = pgTable("adriana_conversations", {
  ...
  asignadaAt:       timestamp("asignada_at", { withTimezone: true }),
  asignadaPor:      uuid("asignada_por").references(() => users.id, { onDelete: "set null" }),
